...
public int Native_CopyProp(Handle hPlugin, int iNumParams)
{
	...
	Entity_GetRenderColor(iEntity, iColor);
...
public int Native_PasteProp(Handle hPlugin, int iNumParams)
{
	...
	Entity_SetSpawnFlags(iEntity, g_sCopyBuffer[iClient][3]);
	Entity_SetSkin(iEntity, g_sCopyBuffer[iClient][4]);
	...
	Cel_SetColorFade(iEntity, view_as<bool>(StringToInt(g_sCopyBuffer[iClient][12])), g_sCopyBuffer[iClient][14], g_sCopyBuffer[iClient][15], g_sCopyBuffer[iClient][16], g_sCopyBuffer[iClient][17], g_sCopyBuffer[iClient][18], g_sCopyBuffer[iClient][19]);
